    ...
    with st.form("form_dados_anamnese_completo", clear_on_submit=False):
        ...
        if btn_enviar:
            ...
            if not dias_c or not horario_c:
                ...
                # RECONSTRUÇÃO DA LÓGICA QUE HAVIA SIDO APAGADA:
                tratamentos = []
                mapeamento_cadastro = [
                ...
                # Montagem final correta e alinhada do DataFrame
                ...
                # Criando explicitamente com a indentação exata de 16 espaços para ficar dentro do "else"
                df_alunos_salvar = df_alunos.fillna("").astype(str).replace("nan", "")
